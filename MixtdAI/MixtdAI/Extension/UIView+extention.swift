...
extension UIViewController {
    ...
    func showAnimationLayer() {
        // Customize your comet
        let width = view.bounds.width
        let height = view.bounds.height
        let colorSet = UIColor.red
...
public extension UIDevice {
    ...
    static let modelNameOldDevice: String = {
        ...
        func mapToDevice(identifier: String) -> String { // swiftlint:disable:this cyclomatic_complexity
            #if os(iOS)
            switch identifier {
            case "iPod5,1":                                       return "1"//iPod touch (5th generation)"
            case "iPod7,1":                                       return "1"//"iPod touch (6th generation)"
            case "iPod9,1":                                       return "1"//"iPod touch (7th generation)"
            case "iPhone3,1", "iPhone3,2", "iPhone3,3":           return "1"//"iPhone 4"
            case "iPhone4,1":                                     return "1"//"iPhone 4s"
            case "iPhone5,1", "iPhone5,2":                        return "1"//"iPhone 5"
            case "iPhone5,3", "iPhone5,4":                        return "1"//"iPhone 5c"
            ...
            case "iPhone9,1", "iPhone9,3":                        return "1"//"iPhone 7"
            case "iPhone9,2", "iPhone9,4":                        return "1"//"iPhone 7 Plus"
            case "iPhone10,1", "iPhone10,4":                      return "1"//"iPhone 8"
            case "iPhone10,2", "iPhone10,5":                      return "1"//"iPhone 8 Plus"
